...
import {
  uiSchema,
  jsonSchema
} from '../../../components/SettingsForm/testSchema/knowledgebaseSettings';
...
const Container = styled.div`
  ...
  & .page-section.knowledgebase-settings {
    padding: 0 0 32px 0;
    .settings-data {
      margin-top: 0;
      margin-bottom: 0;
...
const HelpCenterKnowledgebaseSettings: FC<IProps> = ({ ui, initialValues }) => {
  return (
    <Formik
